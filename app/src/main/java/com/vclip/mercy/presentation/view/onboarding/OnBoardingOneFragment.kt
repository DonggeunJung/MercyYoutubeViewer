...
import com.vclip.mercy.databinding.FragmentOnboardingOneBinding
...
class OnBoardingOneFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentOnboardingOneBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun setupListeners() {
        binding.btNext.setOnClickListener {
            findNavController().navigate(
                R.id.action_onBoardingOneFragment_to_onBoardingTwoFragment)
        }
    }
}